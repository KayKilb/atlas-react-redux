  ...
  return (
    <footer className="sticky bottom-0 left-0 flex w-screen items-center justify-center space-x-8 border-t-2 border-blue bg-off-white-light p-8">
      <form
        ...
        className="flex w-full max-w-4xl items-center space-x-4"
      >
        <input
          type="text"
        ...
        <button
          ...
          className="bg-red-500 hover:bg-red-600 rounded px-6 py-4 text-xl font-semibold text-off-white-light transition"
        >
          Clear Board
        </button>
      </form>
